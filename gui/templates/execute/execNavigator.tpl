...
{* $Id: execNavigator.tpl,v 1.22.2.1 2009/09/10 09:09:22 havlat Exp $ *}
...
{* ===================================================================== *}
<body onLoad="show_hide('tplan_settings','tpn_view_settings',false);">
...
<form method="post" id="filters">
	...
	<div>
		<input type="submit" name="submitOptions" value="{$labels.btn_apply_filter}" style="font-size: 90%;" />
		<input type="submit" id="toggleFilterMode"  name="toggleFilterMode" value="{$gui->toggleFilterModeLabel}"  
			           onclick="toggleInput('advancedFilterMode');" style="font-size: 90%;"  />
	</div>
