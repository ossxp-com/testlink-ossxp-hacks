 ...
 * @modified $Date: 2009/05/07 18:53:16 $ by $Author: schlundus $
 *
 * Rev :
...
function render_req_tree_node($level,&$node,$getArguments,$hash_id_descr,$show_node_id=0)
{
	...
	if (TL_TREE_KIND == 'JTREE')
		...
		$menustring = layersmenu_render_req_node_open($node,$node_type,null,$getArguments,$level,$show_node_id);
...
*/
function layersmenu_render_req_node_open($node,$node_type,$dummy,$getArguments,$level,$show_node_id)
{
